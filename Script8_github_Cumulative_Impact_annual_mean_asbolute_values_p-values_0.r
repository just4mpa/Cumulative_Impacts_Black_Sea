...
#   SCRIPT 8                                            
#   CUMULATIVE IMPACTS
#   Based on annual mean absolute values ( setting p-values=0)
#   BLACK SEA
...
# We calculate p-values of the temporal trends and set to 0 those non-significant values (>0.05) before addin ght impacts together.
...
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Yearly_surface_temperature_1998-2021.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
# If we want to save the plot (as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Yearly_bottom_temperature_1998-2021.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
# If we want to save the plot (as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Yearly_surface_salinity_1998-2021.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
# If we want to save the plot (as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Yearly_surface_chl_1998-2021.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
# If we want to save the plot (as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Yearly_surface_NPP_1998-2021.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/1.a.Physical_trend.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
#writeRaster(thetao_mean1998_2021_slopes_raster, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/surface_thetao_mean1998_2021_slopes_raster.tif", sep="", overwrite=TRUE) #geotif
#writeRaster(bottomT_mean1998_2021_slopes_raster, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/bottomT_mean1998_2021_slopes_raster.tif", sep="", overwrite=TRUE) #geotif
#writeRaster(so_mean1998_2021_slopes_raster, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/surface_so_mean1998_2021_slopes_raster.tif", sep="", overwrite=TRUE) #geotif
...
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/1.b.BGC_trend.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()

#---------------------------------------#	
### 3.2.5. Save the rasters ----
#---------------------------------------#
#writeRaster(chl_mean1998_2021_slopes_raster, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/surface_chl_mean1998_2021_slopes_raster.tif", sep="", overwrite=TRUE) #geotif
#writeRaster(nppv_mean1998_2021_slopes_raster, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/surface_nppv_mean1998_2021_slopes_raster.tif", sep="", overwrite=TRUE) #geotif
#writeRaster(o2_mean1998_2021_slopes_raster,  "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/surface_o2_mean1998_2022_slopes_raster.tif", sep="", overwrite=TRUE) #geotif
...
# If we want to save the image Physical( as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/2.a.Physical_trend_normalized.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
abline(v = p90_value_chl, col = "green", lwd =  2, lty = 2)
...
abline(v = p90_value_npp, col = "green", lwd = 2, lty = 2)
...
abline(v = p90_value_o2, col = "green", lwd = 2, lty = 2)
...
# If we want to save the image BGC( as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/2.b.BGC_trend_normalized.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
thetao_mean1998_2021_pvalue_raster_0_1 <-reclassify(thetao_mean1998_2021_pvalue_raster, rcl, na.rm=TRUE)
# Transform to polygon
thetao_mean1998_2021_pvalue_shp <- rasterToPolygons(thetao_mean1998_2021_pvalue_raster_0_1, fun=function(x){x==1}, n=4, na.rm=TRUE, digits=12, dissolve=TRUE)
...
rcl <- matrix(m, ncol=3, byrow=TRUE) #reclass matrix
# Reclassification of the raster
bottomT_mean1998_2021_pvalue_raster_0_1<-reclassify(bottomT_mean1998_2021_pvalue_raster, rcl, na.rm=TRUE)
# Transform to polygon
bottomT_mean1998_2021_pvalue_shp <- rasterToPolygons(bottomT_mean1998_2021_pvalue_raster_0_1, fun=function(x){x==1}, n=4, na.rm=TRUE, digits=12, dissolve=TRUE)
...
# Reclassification of the raster
so_mean1998_2021_pvalue_raster_0_1 <-reclassify(so_mean1998_2021_pvalue_raster, rcl, na.rm=TRUE)
# Transform to polygon
so_mean1998_2021_pvalue_shp <- rasterToPolygons(so_mean1998_2021_pvalue_raster_0_1, fun=function(x){x==1}, n=4, na.rm=TRUE, digits=12, dissolve=TRUE)
...
rcl
# Reclassification of the raster
chl_mean1998_2021_pvalue_raster_0_1 <- reclassify(chl_mean1998_2021_pvalue_raster, rcl, na.rm=TRUE)
# Transform to polygon
chl_mean1998_2021_pvalue_shp <- rasterToPolygons(chl_mean1998_2021_pvalue_raster_0_1, fun=function(x){x==1}, n=4, na.rm=TRUE, digits=12, dissolve=TRUE)
...
# Reclassification of the raster
nppv_mean1998_2021_pvalue_raster_0_1 <- reclassify(nppv_mean1998_2021_pvalue_raster, rcl, na.rm=TRUE)
# Transform to polygon
nppv_mean1998_2021_pvalue_shp <- rasterToPolygons(nppv_mean1998_2021_pvalue_raster_0_1, fun=function(x){x==1}, n=4, na.rm=TRUE, digits=12, dissolve=TRUE)
...
# Reclassification of the raster
o2_mean1998_2021_pvalue_raster_0_1 <- reclassify(o2_mean1998_2021_pvalue_raster, rcl, na.rm=TRUE)
# Transform to polygon
o2_mean1998_2021_pvalue_shp <- rasterToPolygons(o2_mean1998_2021_pvalue_raster_0_1, fun=function(x){x==1}, n=4, na.rm=TRUE, digits=12, dissolve=TRUE)
...
# If we want to save the image Physical( as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/3.a.Physical_trend_normalized_&_pvalues.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()
...
# If we want to save the image Physical( as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/3.b.BGC_trend_normalized_&_pvalues.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()

# ------------------------------------------ #
## 5.4.  Set to 0 non-significant pixels----
# ------------------------------------------- #
...
# ------------------------------- #
# Temperature
# Create a mask where non-significant values (1) are TRUE
thetao_non_significant_mask <- thetao_mean1998_2021_pvalue_raster_0_1 == 1
unique(values(thetao_non_significant_mask))

# Create a copy of the raster
norm_thetao_mean1998_2021_slopes_raster_copy <- norm_thetao_mean1998_2021_slopes_raster

# Ensure the mask and raster are aligned
compareRaster(norm_thetao_mean1998_2021_slopes_raster_copy, norm_thetao_mean1998_2021_slopes_raster)

# Set non-significant areas in the raster to 0
norm_thetao_mean1998_2021_slopes_raster_copy[thetao_non_significant_mask] <- 0

#plot both to compare
par(mfrow=c(1,2))
plot(norm_thetao_mean1998_2021_slopes_raster_copy)
plot(norm_thetao_mean1998_2021_slopes_raster)

# Bottom Temperature
# Create a mask where non-significant values (1) are TRUE
bottomT_non_significant_mask <- bottomT_mean1998_2021_pvalue_raster_0_1 == 1
unique(values(bottomT_non_significant_mask))

# Create a copy of the raster
norm_bottomT_mean1998_2021_slopes_raster_copy <- norm_bottomT_mean1998_2021_slopes_raster

# Ensure the mask and raster are aligned
compareRaster(norm_bottomT_mean1998_2021_slopes_raster_copy, bottomT_non_significant_mask)

# Set non-significant areas in the raster to 0
norm_bottomT_mean1998_2021_slopes_raster_copy[bottomT_non_significant_mask] <- 0

# Plot both to compare
par(mfrow=c(1,2))
plot(norm_bottomT_mean1998_2021_slopes_raster_copy)
plot(norm_bottomT_mean1998_2021_slopes_raster)


# Salinity
# Create a mask where non-significant values (1) are TRUE
so_non_significant_mask <- so_mean1998_2021_pvalue_raster_0_1 == 1
unique(values(so_non_significant_mask))

# Create a copy of the raster
norm_so_mean1998_2021_slopes_raster_copy <- norm_so_mean1998_2021_slopes_raster

# Ensure the mask and the raster are aligned
compareRaster(norm_so_mean1998_2021_slopes_raster_copy, so_non_significant_mask)

# Set non-significant areas in the raster to 0
norm_so_mean1998_2021_slopes_raster_copy[so_non_significant_mask] <- 0

# Plot both to compare
par(mfrow=c(1,2))
plot(norm_so_mean1998_2021_slopes_raster_copy)
plot(norm_so_mean1998_2021_slopes_raster)

# ------------------------------------- #
### 5.4.2.  Biogeochemical impacts----
# ----------------------------------- #

# Chlorophyll
# Create a mask where non-significant values (1) are TRUE
chl_non_significant_mask <- chl_mean1998_2021_pvalue_raster_0_1 == 1
unique(values(chl_non_significant_mask))

# Create a copy of the raster raster
norm_chl_mean1998_2021_slopes_raster_copy <- norm_chl_mean1998_2021_slopes_raster

# Ensure the mask and the raster are aligned
compareRaster(norm_chl_mean1998_2021_slopes_raster_copy, chl_non_significant_mask)

# Set non-significant areas in the raster to 0
norm_chl_mean1998_2021_slopes_raster_copy[chl_non_significant_mask] <- 0

# Plot both to compare
par(mfrow=c(1,2))
plot(norm_chl_mean1998_2021_slopes_raster_copy)
plot(norm_chl_mean1998_2021_slopes_raster)

# NPP
# Create a mask where non-significant values (1) are TRUE
nppv_non_significant_mask <- nppv_mean1998_2021_pvalue_raster_0_1 == 1
unique(values(nppv_non_significant_mask))

# Create a copy of the raster
norm_nppv_mean1998_2021_slopes_raster_copy <- norm_nppv_mean1998_2021_slopes_raster

# Ensure the mask and the raster are aligned
compareRaster(norm_nppv_mean1998_2021_slopes_raster_copy, nppv_non_significant_mask)

# Set non-significant areas in the raster to 0
norm_nppv_mean1998_2021_slopes_raster_copy[nppv_non_significant_mask] <- 0

# Plot both to compare
par(mfrow=c(1,2))
plot(norm_nppv_mean1998_2021_slopes_raster_copy)
plot(norm_nppv_mean1998_2021_slopes_raster)

# Oxygen
# Create a mask where non-significant values (1) are TRUE
o2_non_significant_mask <- o2_mean1998_2021_pvalue_raster_0_1 == 1
unique(values(o2_non_significant_mask))

# Create a copy of the raster
norm_o2_mean1998_2021_slopes_raster_copy <- norm_o2_mean1998_2021_slopes_raster

# Ensure the mask and the raster are aligned
compareRaster(norm_o2_mean1998_2021_slopes_raster_copy, o2_non_significant_mask)

# Set non-significant areas in the raster to 0
norm_o2_mean1998_2021_slopes_raster_copy[o2_non_significant_mask] <- 0

# Plot both to compare
par(mfrow=c(1,2))
plot(norm_o2_mean1998_2021_slopes_raster_copy)
plot(norm_o2_mean1998_2021_slopes_raster)

# ----------------------------------------------------- #
# 6.  STACK NEW CUMULATIVE IMPACTS (with non-sig=0)----
# ----------------------------------------------------- #
# --------------------------------------------------------------------------- #
## 6.1. Create a collection of physical rasters (with non-sig values to 0) ----
#--------------------------------------------------------------------------------#
# Stack
stacked_raster_copy <- stack(norm_thetao_mean1998_2021_slopes_raster_copy,
                             norm_bottomT_mean1998_2021_slopes_raster_copy, 
                             norm_so_mean1998_2021_slopes_raster_copy)

# Rename
names(stacked_raster_copy) = c("thetao","bottomT", "so" )

# Plot
par(cex.axis = 1.5)
plot(stacked_raster_copy,
     col= magenta_to_blue_palette(100),
     axes = TRUE)

# If we want to save the image Physical( as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/4.a.Physical_trend_normalized_pvalues_0.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()

#----------------------------------------------------------------------------------------#
## 6.2. Create a collection of biogeochemical rasters (with non-sig values to 0) ----
#--------------------------------------------------------------------------------------#
# Stack
stacked_raster2_copy <- stack(norm_chl_mean1998_2021_slopes_raster_copy, 
                              norm_nppv_mean1998_2021_slopes_raster_copy,
                              norm_o2_mean1998_2021_slopes_raster_copy)
# Rename
names(stacked_raster2_copy) = c("chl", "nppv", "o2")

# Plot
par(cex.axis = 1.5)
plot(stacked_raster2_copy, 
     col= magenta_to_blue_palette(100),
     axes = TRUE)

# If we want to save the image Physical( as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/4.b.BGC_trend_normalized_pvalues_0.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()

# ----------------------------------------------------- #
## 6.3. CUMULATIVE IMPACTS Both ----
# ----------------------------------------------------- #
# ----------------------------------------------------- #
### 4.3.1. check resolution and resample if needed ----
# ----------------------------------------------------- #

# Create new one to avoid overwritting them
stand_BGC_impact<-stacked_raster2_copy 
stand_phy_impact<-stacked_raster_copy
...
# ----------------------------------------------------- #
### 6.3.1. create a unique layer of Physical impacts----
# ----------------------------------------------------- #
...
# Save raster
#writeRaster(CI_phy, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/surface_CI_sum_physical_1998-2021_norm2_98_pvalues_0.tif", overwrite=TRUE) #geotif


# ----------------------------------------------------- #
### 6.3.2. create a unique layer of BGC impacts----
# ----------------------------------------------------- #
# Add all the layers of one raster stack
...
# Save Raster
#writeRaster(CI_BGC, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/surface_CI_sum_BGC_1998-2021_norm_2_98_pvalues_0.tif", overwrite=TRUE) #geotif


# If we want to save the image with sum physical and sum BGC( as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/5.Physical_sum_&_BGC_sum.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()

# ---------------------------------------------------------------- #
### 6.3.3. create a unique layer of Physical and BGC impacts----
# ---------------------------------------------------------- #
...
# Save raster
#writeRaster(CI_sum,  "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/surface_CI_sum_1998-2021_norm_2_98_pvalues_0.tif", sep="", overwrite=TRUE) #geotif

# If we want to save the image with sum of all impacts (physical and BGC together ( as.tif)
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/6.All_sum.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()

# ----------------------------------------------------- #
## 6.4. RECLASSIFY RASTERS INTO ITS QUARTILES ----
# ----------------------------------------------------- #

# ------------------------------------------------------------ #
### 6.4.1. Reclassify Product 1 into its quantiles ----
# ------------------------------------------------------------ #  

# Calculate the quantiles for the physical variables
quantiles1 <- quantile(values(CI_phy), probs = c(0.25, 0.5, 0.75), na.rm=TRUE)

# Initialize a new map to avoid overwritting
phy_qtile_hab <-  CI_phy 

# Data frame with the min, Q1, Q2, Q3 and max. 
rcl_phy <- c(-Inf, quantiles1[1], 1,
             quantiles1[1], quantiles1[2], 2,
             quantiles1[2], quantiles1[3], 3,
             quantiles1[3], cellStats(CI_phy, stat=max), 4)

rcl_phy <- matrix(rcl_phy, ncol=3, byrow=TRUE) #reclass matrix
rcl_phy

# Reclassification of the original raster (CI_phy)
# Reclassifying the values with a 1 to 4 numerations
...
# ----------------------------------------------------- #
### 6.4.2. Reclassify Product 2 into its quartiles ----
# ----------------------------------------------------- #
# Calculate the quantiles for the physical variables
...
# Data frame with the min, Q1, Q2, Q3 and max. 
rcl_BGC <- c(-Inf, quantiles2[1], 1,
             quantiles2[1], quantiles2[2], 2,
             quantiles2[2], quantiles2[3], 3,
             quantiles2[3], cellStats(CI_BGC, stat=max), 4)

rcl_BGC <- matrix(rcl_BGC, ncol=3, byrow=TRUE) #reclass matrix
rcl_BGC

# Reclassification of the original raster (CI_BGC)
# Reclassifying the values with a 1 to 4 numerations
...
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/7.Physical_&_BGC_quantiles.tiff", width = 10, height = 10, units = "in", res = 300)
#dev.off()

# ----------------------------------------------------- #
## 6.5. FINAL CUMULATIVE IMPACT MAP----
# ----------------------------------------------------- #
# ----------------------------------------------------- #
### 6.5.1. Visualization bivariate plot ----
# ----------------------------------------------------- #
...
# Display the assembled panel
figS2_panel   

# As .tiff
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/8.a.CI_based_on_mean_annual_values_surface.tiff", width = 800, height = 600, res = 300, units= "px")
#dev.off()

# ----------------------------------------------------- #
### 6.5.2. Rasterize Cumulative impacts map ----
# ----------------------------------------------------- #
...
# ----------------------------------------------------- #
#### 6.5.2.1. Visaulization as Raster Cumulative impacts ----
# ----------------------------------------------------- #
...
#dev.copy(tiff, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/8.b.CI_based_on_mean_annual_values_surface_countries.tiff", width = 800, height = 600, res = 300, units= "px")
#dev.off()

# ----------------------------------------------------- #
#### 6.5.2.2. Save final CI raster ----
# ----------------------------------------------------- #

# Save raster
#writeRaster(CI_raster, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Rasters/CI_based_on_mean_annual_values_surface_pvalues0.tif", overwrite=TRUE) #geotif

# ----------------------------------------------------- #
### 6.5.3.Transform to Polygon----
# ----------------------------------------------------- #
...
# Write the shapefile
#st_write(sf_polygons, "./Outputs/CI_analysis/CI_annual_mean_asbolute_values_pvalues_0/Polygon/CI_based_on_mean_annual_values_surface_pvalues_0.shp")
